...
async fn test_openapi_spec_completeness() {
    ...
    assert!(books_path["get"].is_object(), "GET /api/books should be documented");
    assert!(books_path["post"].is_object(), "POST /api/books should be documented");

    let book_by_id_path = &spec["paths"]["/api/books/{id}"];
    assert!(book_by_id_path["get"].is_object(), "GET /api/books/id should be documented");
    assert!(book_by_id_path["put"].is_object(), "PUT /api/books/id should be documented");
    assert!(book_by_id_path["delete"].is_object(), "DELETE /api/books/id should be documented");
